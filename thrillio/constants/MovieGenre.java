package com.jid.thrillio.constants;
...
public class MovieGenre {
	...
	public static final String SCIFI_AND_FANTASY = "Scifi & Fantasy";
	...
	public static final String TELEVISON = "Television";
	...
	public static final String GAY_AND_LESBIAN = "Gay & Lesbians";
	public static final String CLASSIC_MOVIE_MUSICALS = "Classic Movie Musicals";
	public static final String FAITH_AND_SPRITUALITY = "Faith & Sprituality";
	public static final String FOREIGN_DRAMAS = "Foreign Dramas";
	public static final String FOREIGN_ACTION_AND_ADVENTURE = "Foreign Actons & Adventures";
	...
	public static final String DOCUMENTRIES = "Documentries";
